...
(function( $, window, document, undefined ) {
	...
	function _fnReDraw( settings, holdPosition )
	{
		...
		if ( filter ) {
			_fnFilterComplete( settings, settings.oAnteriorPesquisar );
		}
		else {
	...
	function _fnAjaxParameters( settings )
	{
		var
			...
			features = settings.oFeatures,
			prePesquisar = settings.oAnteriorPesquisar,
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var AnteriorPesquisar = settings.oAnteriorPesquisar;
		...
		var PesquisarFn = function() {
			...
			/* Now do the filter */
			if ( val != AnteriorPesquisar.sPesquisar ) {
				_fnFilterComplete( settings, {
					"sPesquisar": val,
					"bRegex": AnteriorPesquisar.bRegex,
					"bSmart": AnteriorPesquisar.bSmart ,
					"bCaseInsensitive": AnteriorPesquisar.bCaseInsensitive
				} );
		...
		var jqFilter = $('input', filter)
			.val( AnteriorPesquisar.sPesquisar )
			...
			if ( settings === s ) {
				...
				try {
					if ( jqFilter[0] !== document.activeElement ) {
						jqFilter.val( AnteriorPesquisar.sPesquisar );
					}
				}
				catch ( e ) {}
			}
	...
	{
		var oPrevPesquisar = oSettings.oAnteriorPesquisar;
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		var prevPesquisar = settings.oAnteriorPesquisar.sPesquisar;
	...
	function _fnSaveState ( settings )
	{
		...
		var state = {
			...
			Pesquisar:  _fnPesquisarToCamel( settings.oAnteriorPesquisar ),
	...
	function _fnLoadState ( settings, oInit, callback )
	{
		...
		var loaded = function ( s ) {
			...
			if ( s.Pesquisar !== undefined ) {
				$.extend( settings.oAnteriorPesquisar, _fnPesquisarToHung( s.Pesquisar ) );
			}
	...
	_api_register( 'Pesquisar()', function ( input, regex, smart, caseInsen ) {
		...
		if ( input === undefined ) {
			// get
			return ctx.length !== 0 ?
				ctx[0].oAnteriorPesquisar.sPesquisar :
				undefined;
		}
		...
		return this.iterator( 'table', function ( settings ) {
			...
			_fnFilterComplete( settings, $.extend( {}, settings.oAnteriorPesquisar, {
				"sPesquisar": input+"",
	...
	_api_registerPlural(
		...
		function ( input, regex, smart, caseInsen ) {
			return this.iterator( 'column', function ( settings, column ) {
				...
				_fnFilterComplete( settings, settings.oAnteriorPesquisar, 1 );
			} );
		}
	);
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 *
				 *  @dtopt Language
				 *  @name DataTable.defaults.language.paginate.proxima
				 *
				 *  @example
				 *    $(document).ready( function() {
				 *      $('#example').dataTable( {
			 ...
			 *  @type string
			 *  @default Mostras _MENU_ Entradas
			 *
			 *  @dtopt Language
		 ...
		 * * `simple` - 'Anterior' and 'proxima' buttons only
		 * * 'simple_numbers` - 'Anterior' and 'proxima' buttons, plus page numbers
		 * * `full` - 'First', 'Anterior', 'proxima' and 'Last' buttons
		 * * `full_numbers` - 'First', 'Anterior', 'proxima' and 'Last' buttons, plus page numbers
	...
	DataTable.ext = _ext = {
		 ...
		 * * `proxima` - Show proxima page when activated
		 ...
		 *
		 *  @example
		 *    // Show Anterior, proxima and current page buttons only
		 *    $.fn.dataTableExt.oPagination.current = function ( page, pages ) {
		 *      return [ 'Anterior', page, 'proxima' ];
		 *    };
		 */
		pager: {},
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'first', 'Anterior', 'proxima', 'last' ];
		},
		...
		simple_numbers: function ( page, pages ) {
			return [ 'Anterior', _numbers(page, pages), 'proxima' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'first', 'Anterior', _numbers(page, pages), 'proxima', 'last' ];
		},
